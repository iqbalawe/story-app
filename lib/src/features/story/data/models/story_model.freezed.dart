...
class _StoryModel extends StoryModel {
  const _StoryModel({required this.id, required this.name, required this.description, required this.photoUrl, required this.createdAt, this.lat, this.lon}): super._();
